...
export const Sidebar = () => {
  ...
  return (
    <>
      <aside className={cn(
        'fixed inset-y-0 left-0 z-50 w-64 bg-white dark:bg-slate-800 border-r border-gray-200 dark:border-gray-700',
        ...
        <div className="flex h-16 items-center gap-2 px-6 border-b border-gray-200 dark:border-gray-700">
          ...
          <span className="font-semibold text-gray-900 dark:text-white">Fullstack App</span>
        </div>
